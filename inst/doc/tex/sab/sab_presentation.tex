...
\newcommand{\sab}{\bd/mpa/sab}   %  \string~ is a representation of the home directory
  ...
  \frametitle{St Anns Bank (SAB)}
    \begin{columns}[c]
      \begin{column}{.6\textwidth}
        \begin{figure}[h]
          \centering
          %\includegraphics[width=0.6\textwidth]{\mpamap/mpa_closeup.pdf}
...
\begin{frame}
  \begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{\bd/{aegis/temperature}/maps/SSE/bottom.predictions/global/{temperatures.bottom}.png}
...
\begin{figure}[h]
  \centering
  	\begin{tabular}{cc}
      \includegraphics[width=0.5\textwidth]{\sab/numberOfSets.pdf}
      \includegraphics[width=0.5\textwidth]{\sab/toweddistance.pdf}
    \end{tabular}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{\sab/{wing.v.door.byyear}.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{\sab/{wing.v.door}.pdf}
...
\begin{figure}
  \centering
  \begin{tabular}{cc}
  \includegraphics[width=0.5\textwidth]{\sab/{sa.comparison}.pdf} &
  \includegraphics[width=0.5\textwidth]{\sab/{sa.comparison.all}.pdf}
  \end{tabular}
    ...
    \begin{columns}[c]
      ...
      \begin{column}{.4\textwidth}
        \begin{figure}[h]
          ...
          \centering
          \includegraphics[width=1.0\textwidth]{\bd/{bio.snowcrab}/R/maps/{snowcrab.large.males_presence_absence}/snowcrab/climatology/{snowcrab.large.males_presence_absence.mean.climatology.png}
        \end{figure}
      \end{column}
    \end{columns}
...
\begin{column}{.5\textwidth}
  \begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{\bd/{bio.snowcrab}/assessments/2012/timeseries/interpolated/{snowcrab.habitat.sa}.png}
...
\begin{frame}
  ...
  \begin{figure}[h]
    \centering
    %  \includegraphics[width=0.75\textwidth]{\bd/{aegis}/speciescomposition/analysis/SSE/allseasons/complex/maps/{maps.pca1.2010}.png}
  ...
  \frametitle{Semi-variogram}
    \begin{columns}[c]
      \begin{column}{.5\textwidth}
          \begin{figure}
            \centering
            \includegraphics[width=1.0\textwidth]{\sab/matern.jpg}
